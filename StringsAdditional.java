...
class StringsAdditional {
	...
	//replace
	System.out.println("Replacing l with k in hello:"+"hello".replace('l','k'));
	//upper and lower case
	System.out.println("converting 'gmk' to uppercase:"+"gmk".toUpperCase());
	System.out.println("converting 'RAMU' to lower case:"+"RAMU".toUpperCase());

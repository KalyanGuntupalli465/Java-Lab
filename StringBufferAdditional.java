...
public class StringBufferAdditional {
	public static void main(String args[])
	{
		...
		System.out.println("second character in Hello:"+s.charAt(1));
		s.setCharAt(1,'g');
		...
		//replace
		StringBuffer z=new StringBuffer("this is a test");
		System.out.println("replacing is with was:"+z.replace(5, 7, "was"));
		//additional
